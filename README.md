...
``` typescript
import * as pkg from 'https://unpkg.com/ropo@^2.21.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import * as pkg from '//cdn.skypack.dev/ropo@^2.21.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//unpkg.com/ropo@^2.21.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/ropo@2.21.0'
</script>
```
